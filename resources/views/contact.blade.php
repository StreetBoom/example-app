...
<body>
    ...
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form action="{{route('contact_form_process')}}" class="space-y-5 mt-5" method="post">
                @csrf
                <input name="email" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Email" />

                <input name="text" class="w-full h-12 border border-gray-800 rounded px-3" placeholder="Сообщение" />
